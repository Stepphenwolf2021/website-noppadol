...
export default function (eleventyConfig) {
  ...
  for (const p of ["CNAME", "404.html", "liverpool-success-dashboard", "china-trade-dashboard", "worldcup-2026-dashboard", "japanese-woodworking", "punnawolf", "personal-km-template", "personal-library"]) {
